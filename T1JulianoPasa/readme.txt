...
As pastas "shader" e "src" no demo "glsl40_tessellation_basic" devem ser substituídas pelas entregues.

É necessário também substituir os arquivos glslprogram.cpp e glslprogram.h na pasta "Demos_GL4.x/utils", 
pois precisei adicionar um novo setUniform para conseguir criar o efeito das ondas.
